...
async function checkBalance() {
    try {
        ...
        console.log(`Current balance: ${ethers.formatEther(balance)} PLS`);
        ...
        if (balance > 0n) {
            ...
            if (balance >= minRequiredBalance) {
                ...
                console.log(`Balance too low. Need at least ${ethers.formatEther(minRequiredBalance)} PLS for minimum gas price`);
            }
        }
